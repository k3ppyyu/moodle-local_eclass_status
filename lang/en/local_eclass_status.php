...
$string['setting:check_interval_help'] = 'How often to run the health checks. Default: 5 minutes. All results are stored in the dashboard regardless of this setting.';
